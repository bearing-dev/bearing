...
All projects live in one flat workspace. Base folders stay on `main`. Worktrees are created for each task. Manage thousands of worktrees across hundreds of repos from a single terminal, or run multiple parallel sessions.
